  ...
  helmet({
    contentSecurityPolicy: {
      directives: {
        ...
        connectSrc: ["'self'", "http://localhost:5000", "ws://localhost:5000", "https://nkubwbvveyglonxpmveu.supabase.co", "https://sbikelegvxoannghlowv.supabase.co"],
      },
    },
    xssFilter: true,
...
// 2. Dynamic CORS policy (supports any localhost port in dev)
app.use(
  cors({
