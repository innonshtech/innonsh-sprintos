...
export default function LandingPage() {
  useEffect(() => {
    ...
    if(!rm && window.matchMedia('(pointer:fine)').matches) {
      hero && hero.addEventListener('mousemove', handleHeroMove);
      hero && hero.addEventListener('mouseleave', handleHeroLeave);
    }
  ...
  <section className="hero">
    ...
    <div className="wrap hero-grid">
      <div className="hero-text reveal">
        ...
        <h1>Engineering Teams Need <span className="grad">One OS</span>, Not More Tools.</h1>
